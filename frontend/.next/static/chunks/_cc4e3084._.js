...
"[project]/app/(dashboard)/school/classrooms/[id]/report-cards/[reportCardId]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ReportCardDetailPage() {
    ...
    const [showSubjectModal, setShowSubjectModal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [selectedSubjects, setSelectedSubjects] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(DEFAULT_SUBJECTS);
    ...
    const [reportCard, setReportCard] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [customSubjects, setCustomSubjects] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [subjectLoading, setSubjectLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // Fetch students
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ReportCardDetailPage.useEffect": ()=>{
            if (!classroomId || isNaN(Number(classroomId))) {
                setError("Invalid classroom ID.");
                return;
            }
            setError(null);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchClassroomStudents"])(classroomId).then({
                "ReportCardDetailPage.useEffect": (data)=>{
                    setStudents(data);
                    // Initialize scores state for each student if not already set
                    setScores({
                        "ReportCardDetailPage.useEffect": (prev)=>{
                            const newScores = {
                                ...prev
                            };
                            data.forEach({
                                "ReportCardDetailPage.useEffect": (stu)=>{
                                    if (!newScores[stu.id]) {
                                        newScores[stu.id] = {
                                            absent: "",
                                            ...Object.fromEntries(DEFAULT_SUBJECTS.map({
                                                "ReportCardDetailPage.useEffect": (s)=>[
                                                        s,
                                                        ""
                                                    ]
                                            }["ReportCardDetailPage.useEffect"])),
            ...
            }["ReportCardDetailPage.useEffect"]).catch({
                "ReportCardDetailPage.useEffect": ()=>setError("Failed to fetch students for this classroom.")
            }["ReportCardDetailPage.useEffect"]);
        }
    }["ReportCardDetailPage.useEffect"], [
        classroomId
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ReportCardDetailPage.useEffect": ()=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchReportCards"])(classroomId).then({
                "ReportCardDetailPage.useEffect": (cards)=>{
                    const found = cards.find({
                        "ReportCardDetailPage.useEffect.found": (c)=>String(c.id) === String(reportCardId)
                    }["ReportCardDetailPage.useEffect.found"]);
                    setReportCard(found || null);
                }
            }["ReportCardDetailPage.useEffect"]).catch({
                "ReportCardDetailPage.useEffect": ()=>setReportCard(null)
            }["ReportCardDetailPage.useEffect"]);
        }
    }["ReportCardDetailPage.useEffect"], [
        classroomId,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ReportCardDetailPage.useEffect": ()=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchReportCardScores"])(reportCardId).then({
                "ReportCardDetailPage.useEffect": (data)=>{
                    setScores({
                        "ReportCardDetailPage.useEffect": (prev)=>({
                                ...prev,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ReportCardDetailPage.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchCustomSubjects"])().then(setCustomSubjects).catch({
                "ReportCardDetailPage.useEffect": ()=>setCustomSubjects([])
            }["ReportCardDetailPage.useEffect"]);
        }
    }["ReportCardDetailPage.useEffect"], []);
    // Handle select all
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ReportCardDetailPage.useEffect": ()=>{
            if (selectAll) {
                setSelectedStudentIds(students.map({
                    "ReportCardDetailPage.useEffect": (s)=>s.id
                }["ReportCardDetailPage.useEffect"]));
            } else {
    ...
    const handleAddSubject = async ()=>{
        ...
        if (subject && !selectedSubjects.includes(subject) && !DEFAULT_SUBJECTS.includes(subject) && !customSubjects.includes(subject)) {
            ...
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addCustomSubject"])(subject);
    ...
    const handleRemoveCustomSubject = async (subject)=>{
        setSubjectLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteCustomSubject"])(subject);
    ...
    const handleSave = async ()=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveReportCardScores"])(reportCardId, payload);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        ...
        children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("thead", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                children: [
                                    ...
                                    tableSubjects.map((subject)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                            className: "px-4 py-3",
                                            children: subject
                                        }, subject, false, {
                                            fileName: "[project]/app/(dashboard)/school/classrooms/[id]/report-cards/[reportCardId]/page.tsx",
                                ...
                                return students.map((stu, idx)=>{
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                        ...
                                        children: [
                                            ...
                                            tableSubjects.map((subject)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    className: "px-4 py-2 text-center",
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                        type: "text",
                                                        className: "w-16 border rounded px-1 py-0.5 text-center",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                ...
                onClick: async ()=>{
                    try {
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendReportCardSMS"])(reportCardId, selectedStudentIds.length > 0 ? selectedStudentIds : students.map((s)=>s.id));
            ...
            showSubjectModal && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...DEFAULT_SUBJECTS,
                                ...customSubjects
                            ].map((subject)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                    ...
                                    children: [
                                        ...
                                        customSubjects.includes(subject) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            type: "button",
...
_s(ReportCardDetailPage, "7oVk4bu2NUSW1rTErixbnr3LaRw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"]
    ];
});
_c = ReportCardDetailPage;
var _c;
__turbopack_context__.k.register(_c, "ReportCardDetailPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_cc4e3084._.js.map